...
export default function CampusPage() {
  const section = mainNavigation.find((item) => item.href === "/campus");
    ...
    <div className="container mx-auto px-4 py-12 space-y-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 auto-rows-[1fr]">
        {children.map((child, index) => {
          // Извлекаем ключ для иконки из href и добавляем префикс campus-
          const baseKey = child.href.split('/').pop();
          const iconKey = `campus-${baseKey}`;
